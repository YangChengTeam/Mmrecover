    ...
    void onViewClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_price1:  //98元会员框
                ...
                rlPrices.get(0).setBackgroundDrawable(new BackgroundShape(PayActivity.this, 50, R.color.white, 3, R.color.yellow_btn));
                rlPrices.get(1).setBackgroundDrawable(new BackgroundShape(PayActivity.this, 50, R.color.white, 3, R.color.gray_bk2));
                changeTvPayText(GlobalData.payCount3);
                break;
            case R.id.rl_price2: //28元会员框
                PayActivity.this.mIs98 = false;
                rlPrices.get(0).setBackgroundDrawable(new BackgroundShape(PayActivity.this, 50, R.color.white, 3, R.color.gray_bk2));
                rlPrices.get(1).setBackgroundDrawable(new BackgroundShape(PayActivity.this, 50, R.color.white, 3, R.color.yellow_btn));
